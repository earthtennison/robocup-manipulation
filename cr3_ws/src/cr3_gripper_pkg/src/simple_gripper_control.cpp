...
public:
    ...
    void createHandClient()
    {
        ...
        HandClient.reset(new hand_control_client("/cr3_hand_controller/follow_joint_trajectory"));
        ...
        {
            ROS_DEBUG("Waiting for the cr3_hand_controller server to come up");
            ++iterations;
        }
    ...
    void close_gripper()
    {
        ...
        goal.trajectory.joint_names.push_back("joint8");
        goal.trajectory.joint_names.push_back("joint9");
    ...
    void open_gripper()
    {
        ...
        int index = 0;
        goal.trajectory.points[index].positions.resize(2);
        goal.trajectory.points[index].positions[0] = -0.52;
        goal.trajectory.points[index].positions[1] = 0.52;
