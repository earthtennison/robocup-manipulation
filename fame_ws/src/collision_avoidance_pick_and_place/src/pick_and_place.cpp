...
void pick(moveit::planning_interface::MoveGroupInterface& move_group, const geometry_msgs::Pose& goal_pose)
{
  ...
  tf2::Quaternion orientation;
  orientation.setRPY(-tau / 4, -tau / 8, -tau / 4);
  grasps[0].grasp_pose.pose.orientation = goal_pose.orientation;
...
void callBackFunc(const geometry_msgs::Pose& goal_pose)
{
...
int main(int argc, char** argv)
{
  ...
  ros::Subscriber goal_pose = nh.subscribe("goal_pose",100,callBackFunc);
